...
Room.create(name: "Platnium Standard", all_hotel_id: AllHotel.first.id, price: 200, image: "https://mlbufqxx4mlc.i.optimole.com/NUlbwlo.9dVs~44fea/w:2000/h:1334/q:auto/https://tophotel.news/wp-content/uploads/2020/07/Alila-Marea-Bedroom-King-scaled.jpg", room_service: true, fitness_center: true, pool: true, wifi: true, balcony: true, bed_size: "King", availability: true)
